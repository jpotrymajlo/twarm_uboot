...
ifeq ($(CONFIG_UBOOT_IPL),y)
IPL = ipl
U_BOOT_IPL = $(obj)u-boot-ipl.bin
endif
...
ALL += $(obj)u-boot.srec $(obj)u-boot.bin $(obj)System.map $(U_BOOT_NAND) $(U_BOOT_ONENAND) $(U_BOOT_IPL)
ifeq ($(ARCH),blackfin)
ALL += $(obj)u-boot.ldr
endif
...
$(IPL):         $(TIMESTAMP_FILE) $(VERSION_FILE) $(obj)include/autoconf.mk
		$(MAKE) -C ipl/board/$(BOARDDIR) all

$(U_BOOT_IPL):  $(IPL) $(obj)u-boot.bin $(obj)include/autoconf.mk
	        cp $(obj)ipl/u-boot-ipl.bin $(obj)u-boot-booter.bin
...
twarm_config   :       unconfig
	@mkdir -p $(obj)include $(obj)board/twarm
	@mkdir -p $(obj)ipl/board/twarm
	@echo "#define CONFIG_UBOOT_IPL" > $(obj)include/config.h
	@$(MKCONFIG) $(@:_config=) arm arm920t twarm NULL at91rm9200
	@echo "CONFIG_UBOOT_IPL = y" >> $(obj)include/config.mk
...
clean:
	...
	@rm -f $(obj)ipl/{u-boot-ipl,u-boot-ipl.map,System.map}
...
clobber:	clean
	...
	@[ ! -d $(obj)ipl ] || find $(obj)ipl -name "*" -type l -print | xargs rm -f

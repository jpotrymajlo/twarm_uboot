...
static inline void AT91F_RTC_InterruptEnable(
        AT91PS_TC pRtc,   // \arg  pointer to a RTC controller
...
static inline void AT91F_SSC_SetBaudrate (
        AT91PS_USART pSSC,        // \arg pointer to a SSC controller
...
{
    //* Disable interrupts
	pSSC->US_IDR = (unsigned int) -1;

    //* Reset receiver and transmitter
	pSSC->US_CR = AT91C_US_SWRST | AT91C_US_RXDIS | AT91C_US_TXDIS ;
